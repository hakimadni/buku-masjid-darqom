        ...
        <table class="table table-sm mb-0">
            <tbody>
                <tr>
                    <td class="col-4">
                        <span
                            id="start_week_label">{{ __('report.balance_per_date', ['date' => $startWeek->isoFormat('dddd, D MMMM Y')]) }}</span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="col-1 text-right">
                        <span
                            id="current_week_spending_total">{{ format_number($currentWeekSpendingTotal ? -$currentWeekSpendingTotal : 0) }}</span>
                    </td>
                </tr>
                <tr>
                    <td class="col-4">
                        <span
                            id="current_balance_label">{{ __('report.today_balance', ['date' => $this->today->isoFormat('dddd, D MMMM Y')]) }}</span>
                    </td>
                    <td class="col-1 text-right">
